...
./$(EXECUTABLE): $(SRC)/*.cpp
	g++ -g -std=c++17  -I./include -L./lib src/main.cpp	src/Header/camera.cpp	src/stb.cpp	src/Header/Texture.cpp	src/Header/VAO.cpp	src/Header/EBO.cpp	src/Header/VBO.cpp	src/Header/shaderClass.cpp	src/glad.c -o main  -lglfw3dll
